    ...
    if transforms_dir.exists() and transforms_dir.is_dir():
        for transforms_file in tqdm(transforms_dir.iterdir()):
            ...
            collage_gaincomp_file = output_dir / \
                Path(transforms_file.name.replace("-data.pkl", "-collage-gaincomp.jpg"))
            ...
            graphcut_gaincomp_file = output_dir / \
                Path(transforms_file.name.replace("-data.pkl", "-graphcut-gaincomp.jpg"))
