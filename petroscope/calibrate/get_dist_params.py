...
with open('camera_matrix.pkl', 'wb') as outp:
        pickle.dump(camera_matrix, outp, pickle.HIGHEST_PROTOCOL)
with open('dist_coeffs.pkl', 'wb') as outp:
        pickle.dump(dist_coeffs, outp, pickle.HIGHEST_PROTOCOL)
with open('new_camera_matrix.pkl', 'wb') as outp:
        pickle.dump(new_camera_matrix, outp, pickle.HIGHEST_PROTOCOL)